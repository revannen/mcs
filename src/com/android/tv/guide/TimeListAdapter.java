...
class TimeListAdapter extends RecyclerView.Adapter<TimeListAdapter.TimeViewHolder> {
    private static final long TIME_UNIT_MS = TimeUnit.MINUTES.toMillis(60);

    // Ex. 3:00 AM
    private static final String TIME_PATTERN_SAME_DAY = "h:mma";
    // Ex. Oct 21, 3:00 AM
    private static final String TIME_PATTERN_DIFFERENT_DAY = "E M/d, h:mma";
    ...
    public void onBindViewHolder(TimeViewHolder holder, int position) {
        ...
        if (Utils.isInGivenDay(System.currentTimeMillis(), startTime)) {
            ...
            String tmp = timeString.substring(idx, timeString.length()-1);
            tmp = tmp.toLowerCase();
            timeString = timeString.substring(0, idx) + tmp;
        }
